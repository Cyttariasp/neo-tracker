  ...
  return (
    <main className="container content-safe py-3">
      ...
      {transactions.length === 0 ? (
        ...
        // Opción B: tarjeta clara para más contraste global
        <div className="card shadow-sm border-0 rounded-4 bg-white text-dark">
                  ...
                  <div className="d-flex align-items-start">
                    <span
                      ...
                      style={{
                        width: 10,
                        height: 10,
                        backgroundColor: colorByCategory[tx.category] || "#bbb",
                        marginTop: 6,
                      }}
                      aria-hidden="true"
                    />
